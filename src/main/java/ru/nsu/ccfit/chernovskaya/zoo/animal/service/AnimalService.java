...
public interface AnimalService {
    @Nullable
    IndividualDto getIndividualById(int id);

    @Nullable
    List<IndividualDto> getAllIndividuals(Map<String, String> filters, List<String> sorts, int page, int size);

    @Nullable
    List<String> getAllAnimalsTitle();
    ...
    void updateAnimal(@NonNull IndividualRequest animal, int id) throws IOException;
}
